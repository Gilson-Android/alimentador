...
//
//  ATENCAO: esta e a UNICA peca que pede suporte, e so embaixo do flange
//  (uma aba de 3,2mm que salta 13mm do pescoco, a 10mm da mesa). Area pequena
//  e plana, facil de tirar. Ja tentei eliminar com um chanfro de 40 graus, mas
//  isso obrigava as orelhas do colar a subir e elas colidiam com o chanfro --
//  ver cad/check_interferencia.scad.
// =====================================================================
include <common.scad>
...
module hopper() {
    difference() {
        union() {
            // spigot: entra no socket do colar
            translate([0, 0, spig_z0]) rbox(hop_bot, hop_bot, hop_insert, 3);
            // flange (apoia no topo do colar; pede suporte embaixo)
